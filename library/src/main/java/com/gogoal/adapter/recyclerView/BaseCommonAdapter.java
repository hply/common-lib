package com.gogoal.adapter.recyclerView;
...
import com.gogoal.adapter.recyclerView.animation.AlphaInAnimation;
import com.gogoal.adapter.recyclerView.animation.BaseAnimation;
import com.gogoal.adapter.recyclerView.animation.ScaleInAnimation;
import com.gogoal.adapter.recyclerView.animation.SlideInBottomAnimation;
import com.gogoal.adapter.recyclerView.animation.SlideInLeftAnimation;
import com.gogoal.adapter.recyclerView.animation.SlideInRightAnimation;
import com.gogoal.adapter.recyclerView.entity.IExpandable;
import com.gogoal.adapter.recyclerView.loadmore.LoadMoreView;
import com.gogoal.adapter.recyclerView.loadmore.SimpleLoadMoreView;
import com.gogoal.adapter.recyclerView.util.MultiTypeDelegate;
...
public abstract class BaseCommonAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    public void setOnItemClick(View v, int position) {
        getOnItemClickListener().onItemClick(BaseCommonAdapter.this, v, position);
    }
    ...
    public boolean setOnItemLongClick(View v, int position) {
        return getOnItemLongClickListener().onItemLongClick(BaseCommonAdapter.this, v, position);
    }
    ...
    /**
     * When the current adapter is empty, the BaseCommonAdapter can display a special view
     ...
     * @param itemData   The item that needs to be displayed.
     */
    protected abstract void convert(K holder, T itemData);
...
//            subItemCount += list.size();
    ...
    public interface OnItemChildClickListener {
         ...
         */
        void onItemChildClick(BaseCommonAdapter adapter, View view, int position);
    }
    ...
    public interface OnItemChildLongClickListener {
         ...
         */
        boolean onItemChildLongClick(BaseCommonAdapter adapter, View view, int position);
    }
    ...
    public interface OnItemLongClickListener {
         ...
         * @return true if the callback consumed the long click ,false otherwise
         */
        boolean onItemLongClick(BaseCommonAdapter adapter, View view, int position);
    }
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(BaseCommonAdapter adapter, View view, int position);
    }
