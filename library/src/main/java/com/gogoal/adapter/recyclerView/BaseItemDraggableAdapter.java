...
import com.gogoal.adapter.recyclerView.listener.OnItemDragListener;
import com.gogoal.adapter.recyclerView.listener.OnItemSwipeListener;
...
public abstract class BaseItemDraggableAdapter<T, K extends BaseViewHolder> extends BaseCommonAdapter<T, K> {
    ...
    public void onBindViewHolder(K holder, int position) {
        ...
        if (mItemTouchHelper != null && itemDragEnabled && viewType != LOADING_VIEW && viewType != HEADER_VIEW
            ...
            if (mToggleViewId != NO_TOGGLE_VIEW) {
                ...
                if (toggleView != null) {
                    toggleView.setTag(R.id.BaseCommonAdapter_viewholder_support, holder);
                    if (mDragOnLongPress) {
                ...
                holder.itemView.setTag(R.id.BaseCommonAdapter_viewholder_support, holder);
            ...
            mOnToggleViewLongClickListener = new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    if (mItemTouchHelper != null && itemDragEnabled) {
                        mItemTouchHelper.startDrag((RecyclerView.ViewHolder) v.getTag(R.id.BaseCommonAdapter_viewholder_support));
                    }
                    return true;
                }
            };
