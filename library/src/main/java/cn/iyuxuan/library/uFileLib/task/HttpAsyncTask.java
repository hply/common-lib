package cn.iyuxuan.library.uFileLib.task;
...
public class HttpAsyncTask extends AsyncTask<Object, Object, Object> {
    ...
    protected Object doInBackground(Object... params) {
        ...
        try {
            ...
            JSONObject responseHeadersObject = UFileUtils.passHeaders(responseHeaders);
            response.put("headers", responseHeadersObject);
            InputStream is;
